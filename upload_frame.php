...
if(isset($_GET['progress_key'])) { 
   // $status = apc_fetch('upload_'.$_GET['progress_key']); 
    ...
    $key = ini_get("session.upload_progress.prefix") . "add_product_form";
...
// 
    ...
    setInterval(function()  
        {
            console.log('khan');
    $.get("http://mactosys.com/allAboutTheMusic/upload_frame.php?progress_key=<?php echo $_GET['up_id']; ?>&randval="+ Math.random(), {  
