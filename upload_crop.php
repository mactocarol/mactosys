...
if (!isset($_SESSION['random_key']) || strlen($_SESSION['random_key'])==0){
    $_SESSION['random_key'] = uniqid(); //assign the timestamp to the session variable
...
$(window).load(function () { 
	$('#thumbnail').imgAreaSelect({ aspectRatio: '2:<?php echo $thumb_height/$thumb_width;?>', onSelectChange: preview }); 
});
