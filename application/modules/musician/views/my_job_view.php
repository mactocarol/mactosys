                    ...
                    <tbody>
                          <?php if(isset($results)) {
                            ...
                            <tr>
                                ...
                                <td>
                                   <?php echo ($row->status == 0) ? '<a href="'.site_url('feedback/index/'.$row->shareid).'"><button class="btn btn-default">Give Feedback</button></a>': '' ?>
                                   <?php echo ($row->status == 1) ? '<button class="btn btn-info">Waiting for Approval</button>': '' ?>
                                   <?php echo ($row->status == 2) ? '<button class="btn btn-success">Approved</button>': '' ?>
                                   <?php echo ($row->status == 3) ? '<button class="btn btn-danger">Declined</button>': '' ?>
                                </td>
                            </tr>                          
                            <?php  } }?>                            
