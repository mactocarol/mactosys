      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
               ...
               <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                  <form role="form" id="plan_form" name="" method="post" action="<?php echo base_url().'membershipPlan/edit/'.$reslt->id;?>">
                        <!-- text input -->
                        <section class="col-lg-12 connectedSortable">
                             ...
                             <div class="form-group">
                                ...
                                <select class="form-control" name="pic_limit" >
                                    <option value="0">Select picture limit</option>
                             ...
                             <div class="form-group">
                                ...
                                <select class="form-control" name="audio_limit" >
                                    <option value="0">Select audio limit</option>
                             ...
                             <div class="form-group">
                                ...
                                <select class="form-control" name="video_limit" >
                                    <option value="0">Select video limit</option>
                             ...
                             <div class="form-group">
                                ...
                                <select class="form-control" name="sell_limit" >
                                    <option value="0">Select product sell limit</option>
