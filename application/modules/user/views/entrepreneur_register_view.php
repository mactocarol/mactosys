        ...
        <div class="overlay_panel">
        	<div class="login_panel">
                ...
                ?>
                    ...
                    <div class="logo-login text-center"><h5>Signup as Entrepreneur</h5></div>
            		<form method="post" id="add_entrepreneur_form" action="<?php echo site_url('user/user_registers'); ?>">
                        ...
                        <div class="col-md-12"><div class="form-group"><input type="text" placeholder="Company Name" name="companyname" class="input-text-login" required> <i class="fa fa-envelope"></i></div></div>                        
