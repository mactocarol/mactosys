      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
               ...
               <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                  <form role="form" id="link_form" name="" method="post" action="<?php echo base_url().'pages/addfaq'; ?>">
                        <!-- text input -->
                        <section class="col-lg-12 connectedSortable">
                             <div class="form-group">
                                <label>Question </label>
                                <input type="text" class="form-control" name="question" placeholder="Question" value="">
                             </div>
                             <div class="form-group">                                
                                <label>Answer</label>
