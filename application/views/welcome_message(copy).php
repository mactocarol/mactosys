...
<link href="<?php echo base_url('front');?>/css/bootstrap-select.min.css" rel="stylesheet">
    ...
    <header class="row">  
       <div class="container"> 	    
                   ...
                   <div class="navbar-inverse side-collapse in text-uppercase">
                     <nav role="navigation" class="navbar-collapse">
                       ...
                       <div class="other_info pull-right">
                           ...
                           <a href="#"><i class="fa fa-key"></i>sign up</a>
           ...
           <div class="slider_content col-md-12 text-center">
               <div class="row">
                   <h1 class="text-capitalize">aim higher. reach farther. dream bigger</h1>
           ...
           <div class="search_form_top col-md-12">
               ...
               <div class="btn-outer text-center">
                   <a href="#"><i class="fa fa-arrow-circle-o-up"></i>Upload Your Portfolio</a>
                   <a href="#"><i class="fa fa-briefcase"></i>Post Your Requirment</a>
               </div>                        
           </div>    
       </div>
    </header>
...
<section class="news_letter col-md-12 text-center">
    <div class="row"> 
        <div class="container">
            <h2>Upload Your Portfolio For Finding Best Platform</h2>
